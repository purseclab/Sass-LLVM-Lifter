...
.text._Z15fc_layer_simplePfS_S_S_ii_split_0x0110: ; preds = %.text._Z15fc_layer_simplePfS_S_S_ii_split_0x00a0
  ...
  %.121 = and i64 %imad_add.5, -4294967296
  %.122 = lshr i64 %.121, 32
...
.L_x_1_split_0x0930:                              ; preds = %.L_x_1
  ...
  %.879 = and i64 %imad_add.9, -4294967296
  %.880 = lshr i64 %.879, 32
  ...
  %.887 = and i64 %imad_add.10, -4294967296
  %.888 = lshr i64 %.887, 32
...
.L_x_6:                                           ; preds = %.L_x_6, %.L_x_1_split_0x0930
  ...
  %imad_ext4.1 = zext i1 %.931 to i32
...
.L_x_0:                                           ; preds = %.L_x_0.loopexit, %.L_x_1, %.text._Z15fc_layer_simplePfS_S_S_ii_split_0x0060
  ...
  %.972 = and i64 %imad_add.12, -4294967296
  %.973 = lshr i64 %.972, 32
  ...
  %.986 = and i64 %imad_add.13, -4294967296
  %.987 = lshr i64 %.986, 32
...
.text._Z8fc_layerPfS_S_S_ii_split_0x0100:         ; preds = %.text._Z8fc_layerPfS_S_S_ii_split_0x00a0
  ...
  %.115 = and i64 %imad_add.4, -4294967296
  %.116 = lshr i64 %.115, 32
...
.L_x_9_split_0x0900:                              ; preds = %.L_x_9
  ...
  %.866 = and i64 %imad_add.8, -4294967296
  %.867 = lshr i64 %.866, 32
  ...
  %.874 = and i64 %imad_add.9, -4294967296
  %.875 = lshr i64 %.874, 32
...
.L_x_8:                                           ; preds = %.L_x_8.loopexit, %.L_x_9, %.text._Z8fc_layerPfS_S_S_ii_split_0x0060
  ...
  %.962 = and i64 %imad_add.11, -4294967296
  %.963 = lshr i64 %.962, 32
  ...
  %.976 = and i64 %imad_add.12, -4294967296
  %.977 = lshr i64 %.976, 32
...
.L_x_20:                                          ; preds = %.L_x_19, %.text._Z10max_pool2dPfS_iii_split_0x0290
  %R16.0 = phi i32 [ %imad_add.17, %.text._Z10max_pool2dPfS_iii_split_0x0290 ], [ %.571, %.L_x_19 ]
...
.L_x_18:                                          ; preds = %.L_x_18, %.L_x_20_split_0x0360
  ...
  %.306 = and i64 %imad_add.21, -4294967296
  %.307 = lshr i64 %.306, 32
  ...
  %.313 = and i64 %imad_add.22, -4294967296
  %.314 = lshr i64 %.313, 32
  ...
  %.326 = and i64 %imad_add.23, -4294967296
  %.327 = lshr i64 %.326, 32
  ...
  %.339 = and i64 %imad_add.24, -4294967296
  %.340 = lshr i64 %.339, 32
...
.L_x_17_split_0x04d0:                             ; preds = %.L_x_17
  %.425 = add i32 %imad_add.15, %UR4.0
  %.426 = add i32 %.425, 0
  %.432 = load i32, ptr %R4, align 4
  %imad_mul.27 = mul i32 %.426, %Arg_2
  ...
  %.438 = and i64 %imad_add.28, -4294967296
  %.439 = lshr i64 %.438, 32
...
.L_x_17_split_0x05a0:                             ; preds = %.L_x_17_split_0x0590_conditionalExpr_0x0590, %.L_x_17_split_0x0590
  ...
  %.510 = and i64 %imad_add.31, -4294967296
  %.511 = lshr i64 %.510, 32
...
.L_x_17_split_0x05a0_conditionalExpr_0x05b0:      ; preds = %.L_x_17_split_0x05a0
  ...
  %.522 = and i64 %imad_add.32, -4294967296
  %.523 = lshr i64 %.522, 32
...
.L_x_16:                                          ; preds = %.L_x_16.loopexit, %.text._Z10max_pool2dPfS_iii_split_0x0250
  ...
  %.601 = and i64 %imad_add.36, -4294967296
  %.602 = lshr i64 %.601, 32
...
.text._Z4reluPfS_i_split_0x0060:                  ; preds = %Entry_.text._Z4reluPfS_i
  ...
  %.53 = and i64 %imad_add.2, -4294967296
  %.54 = lshr i64 %.53, 32
...
.L_x_28:                                          ; preds = %.L_x_26_split_0x0610, %.text._Z6conv2dPfS_S_iiii_split_0x0130
  %R10.0 = phi i32 [ %imad_add.4, %.text._Z6conv2dPfS_S_iiii_split_0x0130 ], [ %.148, %.L_x_26_split_0x0610 ]
...
.L_x_27_split_0x0260:                             ; preds = %.L_x_27
  ...
  %.198 = and i64 %imad_add.11, -4294967296
  %.199 = lshr i64 %.198, 32
...
.L_x_25:                                          ; preds = %.L_x_25, %.L_x_27_split_0x0260
  ...
  %.210 = and i64 %imad_add.12, -4294967296
  %.211 = lshr i64 %.210, 32
  ...
  %.222 = and i64 %imad_add.14, -4294967296
  %.223 = lshr i64 %.222, 32
  ...
  %.241 = and i64 %imad_add.15, -4294967296
  %.242 = lshr i64 %.241, 32
  ...
  %.254 = and i64 %imad_add.16, -4294967296
  %.255 = lshr i64 %.254, 32
...
.L_x_24_split_0x0460:                             ; preds = %.L_x_24
  %.368 = add i32 %imad_add.5, %UR4.0
  %.369 = add i32 %.368, 0
  %.374 = add i32 %imad_add.9, %UR4.0
  %.375 = add i32 %.374, 0
  store i32 %.375, ptr %R16, align 4
  store i32 4, ptr %R19, align 4
  %.381 = load i32, ptr %R14, align 4
  %imad_mul.18 = mul i32 %.369, %Arg_3
  ...
  %.387 = and i64 %imad_add.19, -4294967296
  %.388 = lshr i64 %.387, 32
  ...
  %.395 = and i64 %imad_add.20, -4294967296
  %.396 = lshr i64 %.395, 32
...
.L_x_24_split_0x0570:                             ; preds = %.L_x_24_split_0x0560_conditionalExpr_0x0560, %.L_x_24_split_0x0560
  ...
  %.477 = and i64 %imad_add.23, -4294967296
  %.478 = lshr i64 %.477, 32
...
.L_x_24_split_0x0570_conditionalExpr_0x0580:      ; preds = %.L_x_24_split_0x0570
  ...
  %.489 = and i64 %imad_add.24, -4294967296
  %.490 = lshr i64 %.489, 32
...
.L_x_23:                                          ; preds = %.L_x_23.loopexit, %.text._Z6conv2dPfS_S_iiii_split_0x00e0
  %.566 = add i32 %.24, 1
  %.567 = add i32 %.566, 0
  %imad_mul.25 = mul i32 %nvvm_ctaid_z, %.567
  %imad_add.25 = add i32 %imad_mul.25, %imad_add
  %imad_mul.26 = mul i32 %imad_add.25, %.567
  ...
  %.585 = and i64 %imad_add.27, -4294967296
  %.586 = lshr i64 %.585, 32

...
.text._Z10max_pool2dPfS_iii_split_0x01f0:
  ; LOP3.LUT @!P2 R21, RZ, c[0x0][0x174], RZ, 0x33, !PT, !P2
...
.L_x_9_split_0x0590:
  ; IMAD @P1 R4, R3, c[0x0][0x170], R4, P1
...
.L_x_9_split_0x05a0:
  ...
  store i32 %"add.53", i32* %"R2_NOTYPE"
  ; IMAD.WIDE @P1 R4, R4, R7, c[0x0][0x160], P1
...
.L_x_16_split_0x0560:
  ; IMAD @P2 R14, R7, c[0x0][0x178], R14, P2
...
.L_x_16_split_0x0570:
  ...
  ; IMAD.WIDE @P2 R14, R14, R19, c[0x0][0x160], P2

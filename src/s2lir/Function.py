...
class Function:
    ...
    def lift(self, llvm_module : llvmir.Module, shared_mem_elements=4096):
        ...
        if existing_fn is not None:
            ...
            # TODO study the LLVM IR generated by clang and determine if we need to add other attributes/dso_local
            # TODO investigate the addition of align in the function param in ptx

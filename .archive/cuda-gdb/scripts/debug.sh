...
sysctl kernel.randomize_va_space=0 # Disables ASLR for debugging. Note: This change persists after the script ends; remember to re-enable ASLR (on the host) if needed.
